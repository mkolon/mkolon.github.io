...
- Here's that pic of my son and me [**preparing to destroy hard drives**](https://class.hillvt.com/assets/IMG_0982.jpg) for operational security when we moved house in Beijing.
...
- I muddied the waters a bit yesterday by mentioning ZTNA again, so to atone, I'm here providing you with the [**official NIST Zero Trust Architecture**](https://csrc.nist.gov/pubs/sp/800/207/final). It's a toughie - you might not want to read the whole thing, but the front-page abstract is pretty accessible.

- Here's the [**NIST AI Risk Management Framework (AI RMF)**](https://www.nist.gov/itl/ai-risk-management-framework) we learned about from the slides. I haven't read it yet but I will - probably on the plane home.
