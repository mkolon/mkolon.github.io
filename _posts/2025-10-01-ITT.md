...
- I mentioned DHCP (Dynamic Host Configuraton Protocol). It's a fundamental part of every network you've ever seen, and it's always been considered solid and secure. For now, [this might interest you](https://www.bleepingcomputer.com/news/security/new-tunnelvision-attack-leaks-vpn-traffic-using-rogue-dhcp-servers/), which we'll talk about on Wednesday.