...
- As far as I can find, Apple hasn't published much about **how** AirDrop works themselves, but there are a few [**decent explanations**](https://www.lifewire.com/what-is-airdrop-how-does-it-work-1994512#:~:text=How%20Does%20AirDrop%20Work%3F,to%20have%20an%20AirDrop%20connection.) of this online. As usual though, a great look into this rather obscure topic is [**on Wikipedia**](https://en.wikipedia.org/wiki/AirDrop)
- Want an example of a site that will never use secure HTTP? Welcome to [**HTTP Forever!**](http://httpforever.com/)
- Here's the [**SSL Labs tool**](https://www.ssllabs.com/ssltest/) that lets you see how secure the bank's (or anyone's) website is.
- [**Hive Systems**](https://www.hivesystems.com) has the password strength matrix and cybersecurity perceptions quick references that you may find interesting and useful.
- [**Let's Encrypt**](https://letsencrypt.org/) is a nonprofit Certificate Authority providing TLS certificates to 450 million websites, including the FDIC'S!
- We only briefly talked about [**Passkeys**](https://fidoalliance.org/passkeys/) but they will probably replace passwords pretty soon. The multi-company organization promulating the idea is [**the FIDO Alliance**](https://fidoalliance.org/).
-  
