...
- We only briefly talked about [**Passkeys**](https://fidoalliance.org/passkeys/) but they will probably replace passwords before too long. The consortium promulating them is [**the FIDO Alliance**](https://fidoalliance.org/).
- The Verizon [**Data Breach Investigation Report**](https://www.verizon.com/business/resources/reports/dbir/) is a great resource to keep you in the know about what threats are out there.
