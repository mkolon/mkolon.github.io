...
- Maybe this one is just for the geeks, but some of you might remember I didn't know what one of the fields in the auth.log file I showed you represented. The short answer is that in the entry
  -Dec  5 18:43:24 boingit sshd[409841]: Invalid user ak from 185.74.6.243 port 34650
- 409841 is the process ID.
- 
