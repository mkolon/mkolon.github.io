...
- Questions developed in the "Questions and Controls" exercise

Spencer 1
What processes govern what might happen with or to the firewall?
Config who does it?
Who reviews?
Does the firewall have the capability to grow and expand? E

Dan 2
what ports are open and why?
When was your last 3rd party audit?
What do the reports and dashboard look like?
What's the process for addressing issues?
...
Humberto 4
Who manages and configures the FW?
Who does day to day monitoring 
How often are reports genreated and what do they look like?
Who gets notificiton?


Caleb 5
What kind of FW and what functions are implemented?
How do you control, monitor, and update it? Who does this?
Reports - what do you do, what do you see?
Bruce - how do you set and monitor your RA controls!

[image](https://github.com/mkolon/mkolon.github.io/assets/6712161/951e190f-c258-45a3-aed1-19c0f7814011)
...
- Maybe this one is just for the geeks, but some of you might remember I didn't know what one of the fields in the auth.log file I showed you was. The answer is that in the entry:
  <p>Dec  5 18:43:24 boingit sshd[409841]: Invalid user ak from 185.74.6.243 port 34650
