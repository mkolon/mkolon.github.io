...
- Here's an article about the FireEye report on [APT38 - the North Korean hacking group](https://www.securityweek.com/north-korean-attacks-banks-attributed-apt38-group/) that (among other things) used weaknesses in the SWIFT banking system to steal a lot of money. They've gotten a lot of press in the last few years - if you just Google APT38 you'll find lots more info.
